...
public final class MapData {
     ...
     * Please see {@link #setSurfaceTile(int, int, Tile, short) this method} for more details.
     * 
     * @param x x location in game world.
     * @param y y location in game world.
     ...
     * @param tileType type of tile. Using cave, trees and bushes constants is not allowed.
     * 
     * @see #setTree(int, int, TreeType, FoliageAge, GrassData.GrowthTreeStage)
     * @see #setBush(int, int, BushType, FoliageAge, GrassData.GrowthTreeStage)
     */
     ...
     * 
     * Under the hood, 1 byte of bush special data is composed in the same way as tree data: {@link #setTree(int, int, TreeType, FoliageAge, GrassData.GrowthTreeStage) setTree}.
     * 
     * @param x x location in game world.
     * @param y y location in game world.
